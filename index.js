...
const options = {
  ...
  gitlabMode: getEnvOrConfig(
    process.env.CZ_GITLAB_MODE,
    config.gitlabMode,
    defaults.gitlabMode
  ),
  ...
  gitlabOptional: getEnvOrConfig(
    process.env.CZ_GITLAB_OPTIONAL,
    config.gitlabOptional,
    defaults.gitlabOptional
  ),
  gitlabPrefix:
    process.env.CZ_GITLAB_PREFIX ||
    config.gitlabPrefix ||
    defaults.gitlabPrefix,
  gitlabLocation:
    process.env.CZ_GITLAB_LOCATION ||
    config.gitlabLocation ||
    defaults.gitlabLocation,
  gitlabPrepend:
    process.env.CZ_GITLAB_PREPEND ||
    config.gitlabPrepend ||
    defaults.gitlabPrepend,
  gitlabAppend:
    process.env.CZ_GITLAB_APPEND ||
    config.gitlabAppend ||
    defaults.gitlabAppend,
