...
describe('commit message', function() {
  ...
  it('only header w/ scope', function() {
    ...
    ).to.equal(`${type}(${scope}): ${gitlab} ${subject}`);
  });
  ...
  it('header and body w/ custom scope', function() {
    ...
    ).to.equal(`${type}(${customScope}): ${gitlab} ${subject}\n\n${body}`);
  });
  ...
  it('skip gitlab task when optional', function() {
    expect(
      commitMessage(
        {
          type,
  ...
  it('default gitlabLocation when unknown', function() {
    expect(
      commitMessage(
        {
          type,
        ...
        { gitlabLocation: 'unknown-location' }
      )
    ).to.equal(`${type}(${scope}): ${gitlab} ${subject}\n\n${body}`);
  });
  it('pre-type gitlabLocation', function() {
    expect(
      commitMessage(
        {
          type,
        ...
        { gitlabLocation: 'pre-type' }
      )
    ).to.equal(`${gitlab} ${type}(${scope}): ${subject}\n\n${body}`);
  });
  it('pre-description gitlabLocation', function() {
    expect(
      commitMessage(
        {
          type,
  ...
  it('post-description gitlabLocation', function() {
    expect(
      commitMessage(
        {
          type,
        ...
        { gitlabLocation: 'post-description' }
      )
    ).to.equal(`${type}(${scope}): ${subject} ${gitlab} \n\n${body}`);
  });
  it('post-body gitlabLocation with body', function() {
    expect(
      commitMessage(
        {
          type,
        ...
        { ...defaultOptions, gitlabLocation: 'post-body' }
      )
    ).to.equal(`${type}(${scope}): ${subject}\n\n${body}\n\n${gitlab}`);
  });
  it('post-body gitlabLocation no body', function() {
    expect(
      commitMessage(
        {
          type,
  ...
  it('post-body gitlabLocation with body and footer', function() {
  ...
  it('gitlabPrepend decorator', function() {
    expect(
      commitMessage(
        {
          type,
  ...
  it('gitlabAppend decorator', function() {
    expect(
      commitMessage(
        {
          type,
  ...
  it('gitlabPrepend and gitlabAppend decorators', function() {
    expect(
      commitMessage(
        {
          type,
  ...
  it('gitlabLocation, gitlabPrepend, gitlabAppend decorators', function() {
    expect(
      commitMessage(
        {
          type,
...
describe('validation', function() {
  ...
  it('empty gitlab if not optional', function() {
    expect(() =>
      commitMessage(
        {
          type,
    ...
    ).to.throw(`Answer '' to question 'gitlab' was invalid`);
  });
});
...
describe('questions', function() {
  it('default gitlab question', function() {
    expect(questionPrompt('gitlab')).to.be.eq('Enter Gitlab issue (12345):');
  });
  it('optional gitlab question', function() {
    expect(questionPrompt('gitlab', [], { gitlabOptional: true })).to.be.eq(
      'Enter Gitlab issue (12345) (optional):'
    );
  });
